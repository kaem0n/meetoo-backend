...
public record UserInfoUpdateDTO(@Size(min = 3, max = 50, message = "Name field length must be between 3 and 50 characters.")
                                String name,
                                @Size(min = 3, max = 50, message = "Surname field length must be between 3 and 50 characters.")
                                String surname,
                                ...
                                String gender,
                                @Size(min = 3, max = 50, message = "Occupation field length must be between 3 and 50 characters.")
                                String occupation,
                                String bio,
